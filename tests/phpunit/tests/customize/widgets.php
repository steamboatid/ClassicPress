...
class Tests_WP_Customize_Widgets extends WP_UnitTestCase {
	...
	public function set_up() {
		...
		$this->assertSameSets( array( 'wp_inactive_widgets', 'sidebar-1', 'sidebar-2', 'sidebar-3' ), array_keys( wp_get_sidebars_widgets() ) );
	 ...
	 * @see https://core.trac.wordpress.org/ticket/36660
	 */
	 ...
	 * @see https://core.trac.wordpress.org/ticket/36389
	 */
	...
	/**
	 * @see https://core.trac.wordpress.org/ticket/34738
